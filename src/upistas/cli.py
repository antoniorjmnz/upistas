...
def main() -> None:
    ...
    run.add_argument("--ocr", action="store_true", help="Habilita OCR de escaneos con Firecrawl; requiere FIRECRAWL_API_KEY")
    ...
    extract.add_argument("--ocr", action="store_true", help="Habilita OCR de escaneos con Firecrawl; requiere FIRECRAWL_API_KEY")
