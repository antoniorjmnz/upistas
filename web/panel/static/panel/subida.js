/* Subir facturas: soltar ficheros en la zona, enseñar cuáles se han elegido y el nombre del lote nuevo.
   Sin esto la pantalla sigue funcionando: se eligen con el botón de siempre y se envía el formulario. */
(function () {
  var zona = document.getElementById("zona-subida");
  var entrada = document.getElementById("facturas");
